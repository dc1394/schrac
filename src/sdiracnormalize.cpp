...
namespace schrac {
    ...
    Normalize<SDiracNormalize>::mymap SDiracNormalize::getresult() const
    {
        Normalize<SDiracNormalize>::mymap wf;
    ...
    void SDiracNormalize::normalize()
    {
